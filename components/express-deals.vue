            ...
            <Carousel :wrapAround="true" v-bind="settings" :breakpoints="breakpoints">
                <Slide v-for="card in expressOne" :key="card">
                    <div class="carousel__item">
                        <div
                            class="relative m-10 w-[300px] max-w-[16rem] overflow-hidden rounded-lg bg-white shadow-md">
                            <div>
                            ...
                            <div class="px-5 pb-5 mt-4">
                                ...
                                <div class="mt-2.5 mb-2 flex items-center">
                                    <span
                                        class="mr-2 rounded bg-yellow-200 px-2.5 py-0.5 text-xs font-semibold">5.0</span>
                                ...
                                <div class="flex items-center justify-between">
                                    <p class="mt-2 ">
                                        <span class="mr-1 text-lg font-bold text-slate-900">EGP{{ card.price }}</span>
